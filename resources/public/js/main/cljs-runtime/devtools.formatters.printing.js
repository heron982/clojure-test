...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq43684){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43685,G__43686,seq43684__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__43694_SHARP_){
return (!((cljs.core.meta(p1__43694_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43703__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e43704){var _e__40721__auto__ = e43704;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e43706){var _e__40721__auto__ = e43706;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__43714 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__43715 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__43715);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43717__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__43714);
}});
...
var temp__5751__auto___43732 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___43732)){
var managed_print_level_43733 = temp__5751__auto___43732;
var _STAR_print_level_STAR__orig_val__43719_43734 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__43720_43735 = managed_print_level_43733;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__43720_43735);
...
job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__43719_43734);
}} else {
job_fn();
}
