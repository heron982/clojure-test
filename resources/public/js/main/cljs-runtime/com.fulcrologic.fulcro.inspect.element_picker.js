...
com.fulcrologic.fulcro.inspect.element_picker.pick_element = (function com$fulcrologic$fulcro$inspect$element_picker$pick_element(p__57224){
var map__57225 = p__57224;
var map__57225__$1 = cljs.core.__destructure_map(map__57225);
var on_pick = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__57225__$1,new cljs.core.Keyword(null,"on-pick","on-pick",-1995648316),cljs.core.identity);
...
var instance = (function (){var G__57226 = target__$1;
if((G__57226 == null)){
return null;
} else {
return com.fulcrologic.fulcro.inspect.element_picker.react_instance(G__57226);
}
})();
...
var G__57235 = goog.dom.getParentElement(target__$1);
target__$1 = G__57235;
continue;
}
} else {
...
var G__57227_57236 = cljs.core.deref(current);
(on_pick.cljs$core$IFn$_invoke$arity$1 ? on_pick.cljs$core$IFn$_invoke$arity$1(G__57227_57236) : on_pick.call(null,G__57227_57236));
...
var state_map = (function (){var G__57228 = com.fulcrologic.fulcro.components.any__GT_app(comp);
var G__57228__$1 = (((G__57228 == null))?null:new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366).cljs$core$IFn$_invoke$arity$1(G__57228));
if((G__57228__$1 == null)){
return null;
} else {
return cljs.core.deref(G__57228__$1);
}
})();
...
}catch (e57229){var _ = e57229;
return null;
}})(),new cljs.core.Keyword("fulcro.inspect.ui.element","static-query","fulcro.inspect.ui.element/static-query",1120589305),(function (){try{var G__57231 = comp;
var G__57231__$1 = (((G__57231 == null))?null:com.fulcrologic.fulcro.components.react_type(G__57231));
if((G__57231__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.components.get_query.cljs$core$IFn$_invoke$arity$1(G__57231__$1);
}
}catch (e57230){var _ = e57230;
return null;
}})(),new cljs.core.Keyword("fulcro.inspect.ui.element","query","fulcro.inspect.ui.element/query",113020567),(function (){try{var G__57233 = comp;
var G__57233__$1 = (((G__57233 == null))?null:com.fulcrologic.fulcro.components.react_type(G__57233));
if((G__57233__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.components.get_query.cljs$core$IFn$_invoke$arity$2(G__57233__$1,state_map);
}
}catch (e57232){var _ = e57232;
return null;
}})()], null);
});
/**
...
var app_uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57234__$1,new cljs.core.Keyword("fulcro.inspect.core","app-uuid","fulcro.inspect.core/app-uuid",-1096445491));
