...
var id = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__60554_SHARP_){
return cljs.core.re_matches(/^#.*/,p1__60554_SHARP_);
}),tokens));
var classes = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__60555_SHARP_){
return cljs.core.re_matches(/^\..*/,p1__60555_SHARP_);
}),tokens);
...
var G__60556 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"classes","classes",2037804510),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(com.fulcrologic.fulcro.dom_common.remove_separators,classes))], null);
if(cljs.core.truth_(sanitized_id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60556,new cljs.core.Keyword(null,"id","id",-1388402092),sanitized_id);
} else {
return G__60556;
}
} else {
...
var map__60559 = com.fulcrologic.fulcro.dom_common.parse(kw);
var map__60559__$1 = cljs.core.__destructure_map(map__60559);
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__60559__$1,new cljs.core.Keyword(null,"classes","classes",2037804510),cljs.core.PersistentVector.EMPTY);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60559__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
var G__60560 = (function (){var or__4253__auto__ = props;
...
var G__60560__$1 = ((cljs.core.seq(classes))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60560,new cljs.core.Keyword(null,"className","className",-1983287057),com.fulcrologic.fulcro.dom_common.combined_classes(classes,existing_classes)):G__60560);
if(cljs.core.truth_(id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60560__$1,new cljs.core.Keyword(null,"id","id",-1388402092),id);
} else {
return G__60560__$1;
}
}
