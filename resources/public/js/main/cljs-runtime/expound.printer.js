...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51660_SHARP_){
return expound.printer.str_width(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__51660_SHARP_,i))));
}),rows));
});
expound.printer.max_row_height = (function expound$printer$max_row_height(row){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51661_SHARP_){
return cljs.core.count(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51661_SHARP_)));
}),row));
});
...
var G__51662 = ["%-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(column_widths,i)),"s"].join('');
var G__51663 = v;
return (expound.printer.format.cljs$core$IFn$_invoke$arity$2 ? expound.printer.format.cljs$core$IFn$_invoke$arity$2(G__51662,G__51663) : expound.printer.format.call(null,G__51662,G__51663));
}),row);
}),multi_row);
}),multi_rows);
});
...
var columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51669_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51669_SHARP_)).length),"-"));
}),header);
var header_columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51670_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51670_SHARP_)).length),"="));
}),header);
...
var iter__4652__auto__ = (function expound$printer$multirow_$_iter__51675(s__51676){
return (new cljs.core.LazySeq(null,(function (){
var s__51676__$1 = s__51676;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__51676__$1);
if(temp__5753__auto__){
var s__51676__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__51676__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__51676__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__51678 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__51677 = (0);
while(true){
if((i__51677 < size__4651__auto__)){
var row_idx = cljs.core._nth(c__4650__auto__,i__51677);
cljs.core.chunk_append(b__51678,(function (){var iter__4652__auto__ = ((function (i__51677,row_idx,c__4650__auto__,size__4651__auto__,b__51678,s__51676__$2,temp__5753__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__51675_$_iter__51681(s__51682){
return (new cljs.core.LazySeq(null,((function (i__51677,row_idx,c__4650__auto__,size__4651__auto__,b__51678,s__51676__$2,temp__5753__auto__,split_row_contents){
return (function (){
var s__51682__$1 = s__51682;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__51682__$1);
if(temp__5753__auto____$1){
var s__51682__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__51682__$2)){
var c__4650__auto____$1 = cljs.core.chunk_first(s__51682__$2);
var size__4651__auto____$1 = cljs.core.count(c__4650__auto____$1);
var b__51684 = cljs.core.chunk_buffer(size__4651__auto____$1);
if((function (){var i__51683 = (0);
while(true){
if((i__51683 < size__4651__auto____$1)){
var col_idx = cljs.core._nth(c__4650__auto____$1,i__51683);
cljs.core.chunk_append(b__51684,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__51995 = (i__51683 + (1));
i__51683 = G__51995;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__51684),expound$printer$multirow_$_iter__51675_$_iter__51681(cljs.core.chunk_rest(s__51682__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__51684),null);
}
} else {
var col_idx = cljs.core.first(s__51682__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__51675_$_iter__51681(cljs.core.rest(s__51682__$2)));
}
} else {
return null;
}
...
});})(i__51677,row_idx,c__4650__auto__,size__4651__auto__,b__51678,s__51676__$2,temp__5753__auto__,split_row_contents))
,null,null));
});})(i__51677,row_idx,c__4650__auto__,size__4651__auto__,b__51678,s__51676__$2,temp__5753__auto__,split_row_contents))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__51678),expound$printer$multirow_$_iter__51675(cljs.core.chunk_rest(s__51676__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__51678),null);
}
} else {
var row_idx = cljs.core.first(s__51676__$2);
return cljs.core.cons((function (){var iter__4652__auto__ = ((function (row_idx,s__51676__$2,temp__5753__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__51675_$_iter__51685(s__51686){
return (new cljs.core.LazySeq(null,(function (){
var s__51686__$1 = s__51686;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__51686__$1);
if(temp__5753__auto____$1){
var s__51686__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__51686__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__51686__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__51688 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__51687 = (0);
while(true){
if((i__51687 < size__4651__auto__)){
var col_idx = cljs.core._nth(c__4650__auto__,i__51687);
cljs.core.chunk_append(b__51688,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__52000 = (i__51687 + (1));
i__51687 = G__52000;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__51688),expound$printer$multirow_$_iter__51675_$_iter__51685(cljs.core.chunk_rest(s__51686__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__51688),null);
}
} else {
var col_idx = cljs.core.first(s__51686__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__51675_$_iter__51685(cljs.core.rest(s__51686__$2)));
}
} else {
return null;
}
...
});})(row_idx,s__51676__$2,temp__5753__auto__,split_row_contents))
;
return iter__4652__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(row)));
})(),expound$printer$multirow_$_iter__51675(cljs.core.rest(s__51676__$2)));
}
} else {
return null;
}
...
var rows = cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [column_keys], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51689_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(p1__51689_SHARP_,column_keys);
}),map_rows));
...
var form = (function (){var G__51720 = via;
var G__51720__$1 = (((G__51720 == null))?null:cljs.core.last(G__51720));
if((G__51720__$1 == null)){
return null;
} else {
return cljs.spec.alpha.form(G__51720__$1);
}
})();
...
var seq__51740_52028 = cljs.core.seq(problems);
var chunk__51741_52029 = null;
var count__51742_52030 = (0);
var i__51743_52031 = (0);
while(true){
if((i__51743_52031 < count__51742_52030)){
var p_52032 = chunk__51741_52029.cljs$core$IIndexed$_nth$arity$2(null,i__51743_52031);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_52032) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__52034 = seq__51740_52028;
var G__52035 = chunk__51741_52029;
var G__52036 = count__51742_52030;
var G__52037 = (i__51743_52031 + (1));
seq__51740_52028 = G__52034;
chunk__51741_52029 = G__52035;
count__51742_52030 = G__52036;
i__51743_52031 = G__52037;
continue;
} else {
var temp__5753__auto___52039 = cljs.core.seq(seq__51740_52028);
if(temp__5753__auto___52039){
var seq__51740_52040__$1 = temp__5753__auto___52039;
if(cljs.core.chunked_seq_QMARK_(seq__51740_52040__$1)){
var c__4679__auto___52041 = cljs.core.chunk_first(seq__51740_52040__$1);
var G__52042 = cljs.core.chunk_rest(seq__51740_52040__$1);
var G__52043 = c__4679__auto___52041;
var G__52044 = cljs.core.count(c__4679__auto___52041);
var G__52045 = (0);
seq__51740_52028 = G__52042;
chunk__51741_52029 = G__52043;
count__51742_52030 = G__52044;
i__51743_52031 = G__52045;
continue;
} else {
var p_52046 = cljs.core.first(seq__51740_52040__$1);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_52046) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__52048 = cljs.core.next(seq__51740_52040__$1);
var G__52049 = null;
var G__52050 = (0);
var G__52051 = (0);
seq__51740_52028 = G__52048;
chunk__51741_52029 = G__52049;
count__51742_52030 = G__52050;
i__51743_52031 = G__52051;
continue;
}
} else {
}
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,k,((cljs.core.qualified_keyword_QMARK_(k))?k:(function (){var or__4253__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51739_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),cljs.core.name(p1__51739_SHARP_));
}),specs));
...
expound.printer.summarize_key_clause = (function expound$printer$summarize_key_clause(p__51770){
var vec__51771 = p__51770;
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51771,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51771,(1),null);
var G__51774 = branch;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51774__$1)].join('')));

}
});
expound.printer.missing_key = (function expound$printer$missing_key(form){
var vec__51778 = cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","contains-key-pred","expound.spec/contains-key-pred",-989075236),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,(2)));
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51778,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51778,(1),null);
var G__51782 = branch;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51782__$1)].join('')));
...
/** @this {Function} */
(expound.printer.format.cljs$lang$applyTo = (function (seq51789){
var G__51790 = cljs.core.first(seq51789);
var seq51789__$1 = cljs.core.next(seq51789);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51790,seq51789__$1);
}));
...
var keys = expound.printer.keywords(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51820_SHARP_){
return expound.printer.missing_key(new cljs.core.Keyword(null,"pred","pred",1927423397).cljs$core$IFn$_invoke$arity$1(p1__51820_SHARP_));
}),problems));
...
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p1__51821_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__51821_SHARP_,"key");
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__51824){
...
var _STAR_print_newline_STAR__orig_val__51830_52071 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__51831_52072 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__51832_52073 = true;
var _STAR_print_fn_STAR__temp_val__51833_52074 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__51832_52073);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__51833_52074);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__51831_52072);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__51830_52071);
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51837_SHARP_){
return expound.ansi.color.cljs$core$IFn$_invoke$arity$variadic(p1__51837_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"correct-key","correct-key",1087492967)], 0));
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(first_line_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)].join('')], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51886_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(rest_lines_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51886_SHARP_)].join('');
}),lines)));
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(displayed_form,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k)),(function (){var G__51917 = show_valid_values_QMARK_;
var G__51918 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k);
...
var G__52089 = show_valid_values_QMARK_;
var G__52090 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(k));
var G__52091 = rst__$1;
show_valid_values_QMARK_ = G__52089;
form = G__52090;
in$ = G__52091;
continue;
} else {
if(cljs.core.associative_QMARK_(form)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(displayed_form,k,(function (){var G__51921 = show_valid_values_QMARK_;
var G__51922 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(form,k);
var G__51923 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__51921,G__51922,G__51923) : expound.printer.summary_form.call(null,G__51921,G__51922,G__51923));
})());
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.seq_QMARK_(form)))){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__51925 = show_valid_values_QMARK_;
var G__51926 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,k);
var G__51927 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__51925,G__51926,G__51927) : expound.printer.summary_form.call(null,G__51925,G__51926,G__51927));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.set_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__51928 = show_valid_values_QMARK_;
var G__51929 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__51930 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__51928,G__51929,G__51930) : expound.printer.summary_form.call(null,G__51928,G__51929,G__51930));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.list_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.List.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__51931 = show_valid_values_QMARK_;
var G__51932 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__51933 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__51931,G__51932,G__51933) : expound.printer.summary_form.call(null,G__51931,G__51932,G__51933));
})()));
} else {
...
var max_width = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51936_SHARP_){
return ((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51936_SHARP_)).length);
...
var map__51938 = problem;
var map__51938__$1 = cljs.core.__destructure_map(map__51938);
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51938__$1,new cljs.core.Keyword("expound","form","expound/form",-264680632));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51938__$1,new cljs.core.Keyword("expound","in","expound/in",-1900412298));
var map__51939 = opts;
var map__51939__$1 = cljs.core.__destructure_map(map__51939);
var show_valid_values_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51939__$1,new cljs.core.Keyword(null,"show-valid-values?","show-valid-values?",-587258094),false);
...
var s = (function (){var _STAR_print_namespace_maps_STAR__orig_val__51944 = cljs.core._STAR_print_namespace_maps_STAR_;
var _STAR_print_namespace_maps_STAR__temp_val__51945 = false;
(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__temp_val__51945);
...
}finally {(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__orig_val__51944);
}})();
var vec__51940 = cljs.core.re_find(regex,s);
...
var line = first__51942;
var first__51942__$1 = cljs.core.first(seq__51941__$1);
var seq__51941__$2 = cljs.core.next(seq__51941__$1);
var prefix = first__51942__$1;
var _more = seq__51941__$2;
