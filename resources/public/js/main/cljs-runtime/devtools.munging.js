...
var o43212 = temp__5751__auto__;
var temp__5751__auto____$1 = (o43212["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o43213 = temp__5751__auto____$1;
return (o43213["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40665__auto__ = f;
return (o__40665__auto__["toString"]).call(o__40665__auto__);
} else {
return "";
}
}catch (e43218){var _ = e43218;
return "";
}});
...
try{var o__40665__auto___43401 = t;
(o__40665__auto___43401["cljs$lang$ctorPrWriter"]).call(o__40665__auto___43401,t,writer);
}catch (e43224){var __43402 = e43224;
}
...
var char_code = (function (){var o__40665__auto__ = (new String(char$));
return (o__40665__auto__["charCodeAt"]).call(o__40665__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40665__auto__ = String;
return (o__40665__auto__["fromCharCode"]).call(o__40665__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__43229 = num_code;
switch (G__43229) {
case (1):
return (185);
...
var o__40665__auto__ = String;
return (o__40665__auto__["fromCharCode"]).call(o__40665__auto__,superscript_code);
});
/**
...
}catch (e43231){var _e__40681__auto__ = e43231;
return false;
}})())){
...
var vec__43232 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43232,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__43239){
var vec__43240 = p__43239;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43240,(0),null);
...
var G__43425 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__43426 = cljs.core.butlast(remaining_tokens);
name_tokens = G__43425;
remaining_tokens = G__43426;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq43236){
var G__43237 = cljs.core.first(seq43236);
var seq43236__$1 = cljs.core.next(seq43236);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43237,seq43236__$1);
}));
...
var vec__43245 = cljs.core.split_with((function (p1__43244_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__43244_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43245,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43245,(1),null);
...
var vec__43251 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43251,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43251,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__43428 = cljs.core.rest(remaining_tokens);
var G__43429 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__43428;
name_tokens = G__43429;
continue;
} else {
...
var vec__43262 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43262,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43262,(1),null);
var vec__43265 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43265,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43265,(1),null);
var vec__43268 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43268,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43268,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43268,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43268,(3),null);
...
var vec__43273 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43273,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43273,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43273,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43273,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43273,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43273,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__43284 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43284,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43284,(1),null);
var vec__43287 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__43295 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__43295) : devtools.munging.parse_fn_info_deep.call(null,G__43295));
})()));
}
} else {
return fn_info;
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__43309){
var vec__43310 = p__43309;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43310,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43310,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43314_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__43314_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43315_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__43315_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__43318){
var vec__43319 = p__43318;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43319,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq43316){
var G__43317 = cljs.core.first(seq43316);
var seq43316__$1 = cljs.core.next(seq43316);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43317,seq43316__$1);
}));
...
var map__43362 = options;
var map__43362__$1 = cljs.core.__destructure_map(map__43362);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43362__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43362__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43362__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43362__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__43363 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43363,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43363,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43363,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43363,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43363,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43363,(5),null);
...
var o__40665__auto__ = f;
return (o__40665__auto__["getBasis"]).call(o__40665__auto__);
});
/**
...
}catch (e43366){var _e__40681__auto__ = e43366;
...
var G__43439 = (obj[cljs.core.first(path)]);
var G__43440 = cljs.core.rest(path);
obj = G__43439;
path = G__43440;
continue;
} else {
...
var _STAR_ = (function (accum,p__43380){
var vec__43381 = p__43380;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43381,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43381,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__43392){
var vec__43393 = p__43392;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43393,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43393,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43393,(2),null);
...
var post_process = (function (p__43397){
var vec__43398 = p__43397;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43398,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43398,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43396_SHARP_){
return (obj[cljs.core.first(p1__43396_SHARP_)]);
}),sorted_matches);
