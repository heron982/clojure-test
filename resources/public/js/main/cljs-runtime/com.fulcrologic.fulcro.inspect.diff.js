...
com.fulcrologic.fulcro.inspect.diff.patch_updates = (function com$fulcrologic$fulcro$inspect$diff$patch_updates(x,p__49508){
var map__49509 = p__49508;
var map__49509__$1 = cljs.core.__destructure_map(map__49509);
var updates = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49509__$1,new cljs.core.Keyword("fulcro.inspect.lib.diff","updates","fulcro.inspect.lib.diff/updates",221795125));
...
com.fulcrologic.fulcro.inspect.diff.patch_removals = (function com$fulcrologic$fulcro$inspect$diff$patch_removals(x,p__49512){
var map__49514 = p__49512;
var map__49514__$1 = cljs.core.__destructure_map(map__49514);
var removals = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49514__$1,new cljs.core.Keyword("fulcro.inspect.lib.diff","removals","fulcro.inspect.lib.diff/removals",-1638817439));
...
var vec__49515 = cljs.core.first(rem);
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(final$,k,(function (p1__49510_SHARP_){
var G__49518 = p1__49510_SHARP_;
var G__49519 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("fulcro.inspect.lib.diff","removals","fulcro.inspect.lib.diff/removals",-1638817439),v], null);
return (com.fulcrologic.fulcro.inspect.diff.patch_removals.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.inspect.diff.patch_removals.cljs$core$IFn$_invoke$arity$2(G__49518,G__49519) : com.fulcrologic.fulcro.inspect.diff.patch_removals.call(null,G__49518,G__49519));
}));
} else {
