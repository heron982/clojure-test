...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__40886){
...
var vec__40890 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40890,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40890,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40890,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_40945 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_40945(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_40952 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_40952(a,b);
}
});
...
var fexpr__40935 = (function (){var G__40936 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__40936__$1)].join('')));
